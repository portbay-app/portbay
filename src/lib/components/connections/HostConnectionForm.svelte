  ...
  const ENV_GROUPS: { label: string; options: { id: string; name: string }[] }[] = [
    {
      ...
      options: [
        ...
        { id: "virtualmin", name: "Virtualmin" },
        { id: "ispconfig", name: "ISPConfig" },
      ],
    },
    {
    ...
    },
    {
      ...
      options: [
        ...
        { id: "oraclecloud", name: "Oracle Cloud" },
        { id: "lambdalabs", name: "Lambda Labs" },
      ],
    },
    {
      label: "Hosting / PaaS",
      options: [
        ...
        { id: "inmotion", name: "InMotion Hosting" },
